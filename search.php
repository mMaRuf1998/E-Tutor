					...
					while($row = $query_sub->fetch_assoc()) { 
						...
						echo '
							...
							<div style="float: right;">';
								...
								$to_email = $cemail;
								$subject = "tution activity";
								$body ="Sir/Madam,I want to learn from you.PLease accept me as your most devoted student";
								$headers = "From: online tutor platform(group11)@gmail.com";
